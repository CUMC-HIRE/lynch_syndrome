...
csy_protocols = ['nono', 'current', 'new']
...
ALL_RUN_MODES = ['CURRENT MARKOV', 'NONO MARKOV', 'NEW MARKOV',
                 'CALIBRATION', "ICER", 'PSA']

all_optimal_strats = [[5, 40], [4, 40], [3, 40], [3, 35], [3, 25], [2, 25], 
                       [1, 25]]

BC_BK_STRATS = {'MLH1': [[3, 35], [3, 25], [2, 25], [1, 25]],
                   'MSH2': [[3, 35], [3, 25], [2, 25], [1, 25]],
                   'MSH6': [[5, 40], [3, 40], [3, 35], [1, 25]],
                   'PMS2': [[5, 40], [4, 40], [3, 40], [3, 35], [1, 25]]}
BC_FLOOR_STRATS = {'MLH1': [[3, 35], [3, 25], [2, 25], [1, 25]],
                   'MSH2': [[3, 35], [3, 25], [2, 25], [1, 25]],
                   'MSH6': [[3, 40], [3, 35], [1, 25]],
                   'PMS2': [[4, 40], [3, 40], [1, 25]]}
BC_OPTIM_STRATS = {'MLH1': [[3, 35], [3, 25], [2, 25], [1, 25]],
                   'MSH2': [[3, 35], [3, 25], [2, 25], [1, 25]],
                   'MSH6': [[3, 40], [3, 35]],
                   'PMS2': [[4, 40], [3, 40]]}     
NAT_HIST = {'MLH1': [[0, 25]],
...
ALL_STATES = {0: 'mutation', # step 0 in all models
...
csy_disutil = util.iloc[8, 0]
compl_disutil = util.iloc[9, 0]
...
cut_ac_mortality_cmb = (cut_ac_mortality + cut_ac_mortality_fm)/2.
